        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <a 
                href="#contact"
                className="inline-flex items-center justify-center bg-blue-500 text-white font-semibold px-8 py-4 rounded-xl text-lg transition-all duration-300 hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-500/20"
              >
      ...
      <section className="py-24 sm:py-32 bg-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-b from-neutral-900 to-black border border-neutral-800 rounded-2xl p-8 transition-all duration-300 hover:border-neutral-700">
              <div className="w-12 h-12 bg-blue-500/10 rounded-xl flex items-center justify-center mb-6 group-hover:bg-blue-500/20 transition-colors">
                <Shield className="w-6 h-6 text-blue-400" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-4">Professional Installation</h3>
              <p className="text-neutral-400 mb-6">Expert mounting, precise aiming, and weather-resistant setup designed for {location.name}&apos;s climate conditions.</p>
            ...
            <div className="group bg-gradient-to-b from-neutral-900 to-black border border-neutral-800 rounded-2xl p-8 transition-all duration-300 hover:border-neutral-700">
              ...
              <p className="text-neutral-400 mb-6">Eliminate dead zones throughout your {location.name} property with professional mesh network setup.</p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-sm text-neutral-300">
                  <CheckCircle className="w-4 h-4 text-green-500" />
                  Mesh network design
            ...
            <div className="group bg-gradient-to-b from-neutral-900 to-black border border-neutral-800 rounded-2xl p-8 transition-all duration-300 hover:border-neutral-700">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Local Support</h3>
              <p className="text-neutral-400 mb-6">Based in the DMV area, we provide rapid response and ongoing support for all {location.name} customers.</p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-sm text-neutral-300">
                  <CheckCircle className="w-4 h-4 text-green-500" />
